export default [
  ...
  {path: '/privileges/department-staff-management', component: require('../pages/privileges/department-staff-management.vue')},
  ...
  {path: '/order/postpaid-orders', component: require('../pages/order/postpaid-orders')},
  ...
  // 银行流水录入 银行流水预警
  {path: '/risk-control/bank-entry', component: require('../pages/risk/bank-entry')},
  {path: '/risk-control/bank-flow-warning', component: require('../pages/risk/bank-flow-warning')},
  ...
  // 商务-我的业绩
  {path: '/performance/my-performance', component: require('../pages/depAchieveStatistics/my-achievement')},

  // 站点流水
  {path: '/risk/company-info', component: require('../pages/risk/company_detail')},
  {path: '/risk/company-flow', component: require('../pages/risk/company_flow')},
  // 风控管理
