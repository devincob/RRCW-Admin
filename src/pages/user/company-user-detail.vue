  ...
  >
    <div style="max-width:1024px">
      <el-card class="el-card-mini no-border-radius no-box-shadow">
        <div slot="header">账号信息(用户编号：{{companyUserId}})</div>
        <el-form
          :model="formInfo"
          :rules="infoRules"
          ref="formUserInfo"
        ...
        >
          <el-row :gutter="20">
            <el-col :md="12">
              ...
              <el-form-item
                v-if="formInfo.userType === 'C'"
                label="公司简称："
              >
                <el-input
                  v-model="formInfo.shortName"
                  style="width: 200px"
                />
              </el-form-item>
              <el-form-item
                :label="formInfo.userType === 'C' ? '公司全称：' : '姓名：'"
                prop="companyUserName"
              >
                <el-input
                  v-model="formInfo.companyUserName"
                  style="width: 200px"
                />
              </el-form-item>
              <el-form-item
              ...
              <el-form-item label="订单确认时间：">
                <el-input
                  v-model="formInfo.autoPayHour"
                  style="width: 200px"
                />
              </el-form-item>
              <el-form-item label="服务费：">
                <el-input
                  v-model="formInfo.serviceChargeRate"
                  style="width: 200px"
                />
              </el-form-item>
