  ...
  <x-page breadcrumb="auto" title="开票站点预警">
    <el-card class="box-card" style="min-width: 600px;max-width: 1024px">
      ...
      <el-table
        ...
        size="mini"
        style="width: 100%;">
        <el-table-column prop="companyName" label="站点名称" min-width="120" align="center">
          <company-details-dialog slot-scope="scope" :company-id="scope.row.companyId">
            <span>{{scope.row.companyName}}</span>
          </company-details-dialog>
        </el-table-column>
        <el-table-column prop="customerName" label="客户" min-width="70" align="center">
          <customer-details-dialog slot-scope="scope" :customer-id="scope.row.customerId">
            {{scope.row.customerName}}
          </customer-details-dialog>
        </el-table-column>
        <el-table-column prop="bussinessName" label="商务" min-width="70" align="center"/>
