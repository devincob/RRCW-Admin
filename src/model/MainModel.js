...
export default class MSModel extends Model {
  ...
  /**
   *名称：Order.企业取消 路由：/Order/Do/CCancel
   *@param {*} params 向服务器传送的参数,对应Request
   *@param {Function} [callback]  回调函数
   *Request:
   {
   ...
   *Response:
   bool
   */
  orderDoCCancel(params, callback){
    return this.modelExecute('/Order/Do/CCancel', params, callback)
  }
  /**
  ...
  /**
   *名称：Order.换人 路由：/Order/Do/ChangeWorker
   *@param {*} params 向服务器传送的参数,对应Request
   *@param {Function} [callback]  回调函数
   *Request:
   {
  ...
  /**
   *名称：Order.退工 路由：/Order/Do/NoNeed
   *@param {*} params 向服务器传送的参数,对应Request
   *@param {Function} [callback]  回调函数
   *Request:
   {
  ...
  /**
   *名称：Order.旷工 路由：/Order/Do/NoWork
   *@param {*} params 向服务器传送的参数,对应Request
   *@param {Function} [callback]  回调函数
   *Request:
   {
  ...
  /**
   *名称：Order.事件详情 路由：/Order/Query/EventDetail
   *@param {*} params 向服务器传送的参数,对应Request
   *@param {Function} [callback]  回调函数
   *Request:
   {
   ...
   *Request:
   {
       ...
       //1预约中,2待上班,3上班中,4待支付,5已支付,6取消,7超时无人抢,8已确认未支付
