  ...
  <el-container>
    <el-header height="60px">
      ...
      <div class="el-header-right">
        <a class="top-link-item" target="_blank" v-if="$user.userInfo.flowRoleId === 12" href="/performance/my-performance">
          我的业绩
        </a>
        <el-menu
          ...
          <el-submenu index="/">
            <template slot="title">
              <i class="el-icon-setting" style="font-size: 30px;width: auto;color: white;"></i>{{$user.userInfo.adminRoleName}}-{{$user.userInfo.userName||'我的工作台'}}
            </template>
